-- Replace moderator role with manager and implement manager permissions (fixed order)

-- Step 1: Add 'manager' value to the app_role enum
ALTER TYPE public.app_role ADD VALUE 'manager';

-- Step 2: Update existing user_roles records from 'moderator' to 'manager'
