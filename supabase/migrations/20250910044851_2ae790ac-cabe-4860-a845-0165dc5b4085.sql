...
BEGIN
    ...
    -- Insert English translations with both display_name and default_value
    INSERT INTO template_variable_translations (variable_id, language_code, display_name, default_value) VALUES
    (first_name_id, 'en', 'First Name', 'First Name'),
    (last_name_id, 'en', 'Last Name', 'Last Name');
END $$;