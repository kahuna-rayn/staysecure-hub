-- Fix the get_outdated_lessons function to properly return lessons with outdated content
...
-- Also fix the get_translation_dashboard_stats function for consistency
