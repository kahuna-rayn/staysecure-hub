-- Check the valid enum values for app_role
...
-- Create new policies for super_admin and Author roles (using correct case)
...
-- Update the log_translation_change function to use SECURITY DEFINER
